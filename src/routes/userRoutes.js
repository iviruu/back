...
router.post('/create', authenticateToken([2]), createResultados);
...
router.post('/teacher/create', authenticateToken([2]), createRelacionAlumnoProfesor);
router.get('/teacher/alumnos/:teacher_id', authenticateToken([2]), getAlumnosByProfesor);
router.get('/teacher/alumnosList', authenticateToken([2]), getAlumnosList);
router.get('/alumno/relacion/:alumno_id', authenticateToken([1]), getRelacion);
router.post('/alumno/update_relacion/:relacion_id', authenticateToken([1]), updateRelacion);
...
router.get('/profe/relacion/:teacher_id', authenticateToken([2]), getRelacionIdProfesor);
router.delete('/profe/delete_relacion/:relacion_id', authenticateToken([2]), deleteRelacion);
